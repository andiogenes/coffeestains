...
\begin{itemize}
\item \verb|\coffeestainA|, a $270^\circ$ circle stain with two tiny splashes, like \vpageref{stainA}
\item \verb|\coffeestainB|, a $60^\circ$ circle stain, as \vpageref{stainB}
\item \verb|\coffeestainC|, two splashes with light colours, as \vpageref{stainC}
\item and \verb|\coffeestainD|, a colourful twin splash, as \vpageref{stainD}
\end{itemize}
...
\item More infos in the \texttt{CHANGELOG.md} file, including the list of this
  manual's translations.
\end{itemize}
